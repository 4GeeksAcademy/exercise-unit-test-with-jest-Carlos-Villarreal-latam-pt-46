...
// prueba de segundo test para yen
test("One euro should be 156.5 Yen", function() {
    ...
    // Hago mi comparacion (la pruebo)
    expect(fromEuroToDollar(3.5)).toBe(3.745); // 1 euro son 1.07 dolares, entonces 3.5 euros son 3.74 dolares
})
